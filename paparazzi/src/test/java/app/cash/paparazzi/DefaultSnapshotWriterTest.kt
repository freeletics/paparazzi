...
class DefaultSnapshotWriterTest {
  @get:Rule
  ...
  @Test
  fun happyPath() {
    val htmlReportWriter = DefaultSnapshotWriter(reportRoot.root)
    ...
    assertThat(File("${reportRoot.root}/snapshots.json")).hasContent(
      """
        |[
        |  {
        |    "name": "loading",
        ...
        |      "redesign"
        |    ],
        |    "file": "images/9069ca78e7450a285173431b3e52c5c25299e473.png"
        |  }
        |]
      """.trimMargin()
    )
